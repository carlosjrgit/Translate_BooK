...
MODULES = [
    ...
    "book_translator.analysis.ner",
    "book_translator.analysis.alias_resolver",
    "book_translator.analysis.relation_extractor",
    "book_translator.analysis.book_analyzer",
    "book_translator.memory",
    "book_translator.memory.base",
    "book_translator.memory.models",
    "book_translator.memory.character_memory",
