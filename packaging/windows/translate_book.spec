...
hiddenimports = [
    ...
    "book_translator.ui.components.about_widget",
    "book_translator.ui.components.segment_edit_dialog",
    "book_translator.ui.components.promote_entities_dialog",
    "book_translator.ui.components.model_setup_dialog",
    "book_translator.ui.components.metrics_bar",
    "book_translator.ui.components.qa_alerts_widget",
    "book_translator.ui.components.analysis_summary_widget",
    "book_translator.ui.components.advanced_panel",
    ...
    "book_translator.analysis.analyzer",
    "book_translator.analysis.models",
    "book_translator.memory",
    "book_translator.memory.base",
    "book_translator.memory.models",
    "book_translator.memory.sqlite",
    "book_translator.qa",
    "book_translator.qa.base",
    "book_translator.qa.deterministic",
    "book_translator.qa.orchestrator",
    "book_translator.translation",
    "book_translator.translation.base",
    "book_translator.translation.madlad",
